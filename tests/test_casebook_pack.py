"""Regression checks for the escrow-kit casebook."""
...
from casebook.harness import assert_expected, escrow_kit_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(escrow_kit_summary(), assert_expected())
