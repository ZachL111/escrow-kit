...
escrow-kit is a Solidity project for blockchain tooling. It focuses on this technical goal: Model escrow release, refund, timeout, and invariant scenarios.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 155, risk penalty 6, latency penalty 2, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
