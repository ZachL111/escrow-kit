...
`escrow-kit` is centered on blockchain tooling work in Solidity. The technical target is: Model escrow release, refund, timeout, and invariant scenarios.
...
The score is deterministic. The current threshold is 155. Risk has a penalty of 6, latency has a penalty of 2, and weight contributes a bonus of 5.
